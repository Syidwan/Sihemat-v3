    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Account Info Card (for additional details)
              ...
              child: Column(
                children: [
                  if (_currentAccount!.role == 'pengguna') ...[
                    _buildInfoRow(Icons.phone, 'Telepon', _currentAccount!.phone ?? '-'),
                    SizedBox(height: 12),
                    _buildInfoRow(Icons.directions_car, 'Plat Nomor', _currentAccount!.platNomor ?? '-'),
                    if (_currentAccount!.assignedVehicleId != null) ...[
                      SizedBox(height: 12),
                      _buildInfoRow(
                        Icons.credit_card,
                        'Kendaraan',
                        VehicleRepository.getVehicleById(_currentAccount!.assignedVehicleId!)?.code ?? '-'
                      ),
                    ],
